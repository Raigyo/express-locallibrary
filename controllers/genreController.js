...
exports.genre_create_post =  [
  ...
  // Validate that the name field is not empty. - trim() removes blank before and after
  validator.body('name', 'Genre name required').trim().isLength({ min: 1 }),//check if not blank with trim
